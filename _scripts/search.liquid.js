...
ninja.data = [
  ...
  {%- if site.posts_in_search -%}
    ...
    {%- endfor -%}
  {%- endif -%}
  {%- comment -%}Collections (projects, publications, etc.) excluded from search — navigation only.{%- endcomment -%}
  {%- if site.socials_in_search -%}
    ...
    {%- endfor -%}
  {%- endif -%}
  {%- comment -%}Theme switcher entries excluded — theme is fixed to dark.{%- endcomment -%}
];
